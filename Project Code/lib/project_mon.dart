...
class _project_mon_State extends State<project_mon> {
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        'Metric category (This is the badge)',
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'First metric criteria',
                                    border: InputBorder.none,
                                  ),
                                ),
                              ))),
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Second metric criteria',
                                    border: InputBorder.none,
                                  ),
                                ),
                              ))),
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Third metric criteria',
                                    border: InputBorder.none,
                                  ),
                                ),
                              ))),
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Fourth metric criteria',
                                    border: InputBorder.none,
                                  ),
                                ),
                              ))),
  ...
  _onDone() {
    ...
    for (int i = 0; i < cards.length; i++) {
      var metOne = met1[i].text;
      var metTwo = met2[i].text;
      var metThree = met3[i].text;
      var metfour = met4[i].text;
      var metfive = met5[i].text;
      entries.add(PersonEntry(metOne, metTwo, metThree, metfour, metfive));
    }
  ...
  String text3 = "No value entered!";
  String text4 = "No value entered!";
  String text5 = "No value entered!";
        ...
        child: Column(
          children: [
                        ...
                        children: <Widget>[
                          Container(
                            child: Row(children: [
                              ...
                              Padding(
                                padding: EdgeInsets.fromLTRB(35, 22, 0, 0),
                                child: Container(
                                  width: 65.0,
                                  height: 35.0,
                                  decoration: BoxDecoration(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: EdgeInsets.fromLTRB(15, 0, 0, 0),
                              child: TextField(
                                controller: _reasonableRiskNewMet,
                                keyboardType: TextInputType.number,
                                decoration: InputDecoration(
                                  labelText: 'Vote',
                                  border: InputBorder.none,
            ...
            TextButton(
              ...
              child: Text('View score'),
              onPressed: calculateRisksNewMet,
            ),
            Center(
              child: Container(
                decoration: BoxDecoration(
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _lowRisk == null
                                        ? "Required"
                                        : "${_lowScoreNewMet.toStringAsFixed(9)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.red,
                                    ),
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _lowRisk == null
                                        ? "Required"
                                        : "${_medScoreNewMet.toStringAsFixed(9)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.blue,
                                    ),
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _lowRisk == null
                                        ? "Required"
                                        : "${_highScoreNewMet.toStringAsFixed(0)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.green,
                                    ),
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _lowRisk == null
                                        ? "Required"
                                        : "${_totalVotesNewMet.toStringAsFixed(0)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: Colors.black,
                                    ),
                        ...
                        Padding(
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.fromLTRB(3, 5, 0, 0),
                                  child: Text(
                                    _riskNewMet < 0.3333333333
                                        ? "🟩"
                                        : (_riskNewMet > 0.3333333333) &&
                                                (_riskNewMet < 0.6666666667)
                                            ? "🟨"
                                            : (_riskNewMet > 0.666666666)
                                                ? "🟥"
                                                : "",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
